...
def award_coins(data: SaveData, stars: int) -> int:
    """Adiciona COINS_PER_STAR * stars ao saldo. Retorna moedas ganhas."""
...
def purchase_skin(data: SaveData, skin_id: str, cost: int) -> bool:
    """Tenta comprar skin. Retorna True se sucesso, False se saldo insuficiente ou já desbloqueada."""
